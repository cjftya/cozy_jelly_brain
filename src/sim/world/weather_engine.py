...
class WeatherEngine:
    ...
    def tick(self, time_scale, season):
        ...
        if self.remaining_hours <= 0 or (
            season == SeasonType.SUMMER and self.weather_type == WeatherType.SNOWY
        ):
    ...
    def _update_weather(self, season):
        ...
        if season == SeasonType.SUMMER and new_weather_type == WeatherType.SNOWY:
            ...
            season in [SeasonType.SPRING, SeasonType.AUTUMN]
            and new_weather_type == WeatherType.SNOWY
        ):
